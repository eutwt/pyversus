"""Example DuckDB relations and optional PySpark DataFrames."""
...
def example_cars_a_spark(spark: Optional["SparkSession"] = None) -> "DataFrame":
    """Return the example table A as a PySpark DataFrame."""
    from ._spark import examples as spark_examples

    return spark_examples.example_cars_a(spark)
...
def example_cars_b_spark(spark: Optional["SparkSession"] = None) -> "DataFrame":
    """Return the example table B as a PySpark DataFrame."""
    from ._spark import examples as spark_examples

    return spark_examples.example_cars_b(spark)


def resolve_spark(spark: Optional["SparkSession"] = None) -> "SparkSession":
    """Resolve the Spark session used by the Spark example helpers."""
    from ._spark import examples as spark_examples

    return spark_examples.resolve_spark(spark)


__all__ = [
    "example_cars_a",
    "example_cars_a_spark",
    "example_cars_b",
    "example_cars_b_spark",
    "resolve_connection",
    "resolve_spark",
]
